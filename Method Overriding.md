...
class Shark(Fish):
    def type(self):
        print("Shark is a carnivorous fish.")
...
s.type()
## OUTPUT
<img width="1918" height="900" alt="image" src="https://github.com/user-attachments/assets/759a48a1-41f5-4f60-9991-9fbcfd6807d0" />
